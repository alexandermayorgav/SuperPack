...
Public Class ServicioP
    ...
    Private _item As BindingList(Of ItemServicio)
    ...
    Sub New()
        _item = New BindingList(Of ItemServicio)
        Iva = True
        Estatus = True
    ...
    Sub New(ByVal id As Integer, ByVal descripcion As String, ByVal codigo As String, ByVal costo As Decimal, ByVal precio As Decimal, ByVal item As BindingList(Of ItemServicio), ByVal iva As Boolean, ByVal status As Boolean)
        Me.Id = id
    ...
    '    End Set
    'End Property
    Public Property Items() As BindingList(Of ItemServicio)
        Get
            Return _item
        End Get
        Set(ByVal value As BindingList(Of ItemServicio))
            _item = value
        End Set
    End Property
